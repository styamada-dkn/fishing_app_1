  ...
  public: {
    Tables: {
      ...
      mst_credentials: {
        ...
        Relationships: [
          {
            foreignKeyName: "mst_credentials_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "mst_accounts"
      ...
      post_liked: {
        ...
        Relationships: [
          {
            foreignKeyName: "post_liked_liked_user_id_fkey"
          ...
          {
            foreignKeyName: "post_liked_post_id_fkey"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "posts"
            referencedColumns: ["id"]
        ...
        Relationships: [
          {
            ...
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "mst_category"
            referencedColumns: ["id"]
          },
          {
